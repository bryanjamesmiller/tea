...
<div class="grid grid-cols-3">
    ...
    <div>
        <form method="POST" action="{{ route('ingredient_product.store') }}">
            ...
            <a href="{{ route('product.create') }}" class="w-full py-4 px-4 bg-blue-500 text-white font-semibold rounded-full shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75">
